...
class AboutSets(Koan):
    ...
    def test_sets_are_unordered(self):
        self.assertEqual(set(['4', '3', '2', '5', '1']), set('12345'))
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        # TODO: Figure out what the bit operator ^ does exactly
    ...
    def test_we_can_compare_subsets(self):
        ...
        # TODO: Figure out why cake set is not greater than the pie set
